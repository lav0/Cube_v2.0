...
//
//=============================================================================
RubicsCubeManager::RubicsCubeManager()
  : m_time_moment(0.f)
  , m_time_lapsed(0.f)
{
}
                                   ...
                                   )
{
  ...
  setUpMouseHandler(view_projection.get());
...
//=============================================================================
void RubicsCubeManager::setUpMouseHandler(
...
)
{
  ...
  m_mouse_handler = std::make_unique<MouseHandler>(
    centre,
    eye_direction,
    eye_up_of_view,
    eye_to_centre,
