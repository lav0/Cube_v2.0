...
//
//=============================================================================
RubicsMouseHandler::RubicsMouseHandler(
...
//=============================================================================
void RubicsMouseHandler::Listen(bool a_pressed, float a_x, float a_y)
//
// 
//
{
...
//=============================================================================
rcbQuaternion RubicsMouseHandler::Transformation() const
//
//
//
{
...
//=============================================================================
bool RubicsMouseHandler::findPointOnSphere(
  float a_x, 
  float a_y, 
...
//=============================================================================
bool RubicsMouseHandler::rotationStartIsZero() const
//
//
//
{
