...
//=============================================================================
RubicsSingleCube::RubicsSingleCube(
...
//=============================================================================
void RubicsSingleCube::Rotate(const rcbQuaternion& a_quaternion)
{
  m_quat_rotation = a_quaternion * m_quat_rotation;
}

//=============================================================================
void RubicsSingleCube::Turn(eTurnAxis axis, eAngle angle, const rcbQuaternion& quat_full_turn)
{
...
//=============================================================================
void RubicsSingleCube::EndTurn(const rcbQuaternion& quat_full_turn)
//
...
//=============================================================================
bool RubicsSingleCube::IsPlacedOn(Dimention x, Dimention y, Dimention z) const
{
